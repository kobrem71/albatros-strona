...
import { PLAYERS, slugify } from "./players.js?v=40";
import { RECURRING_RULES, EXTRA_EVENTS, TYPE_META } from "./schedule.js?v=40";
import { isFirebaseConfigured, isPushConfigured, FIREBASE_VAPID_KEY } from "./firebase-config.js?v=40";
...
import {
  ...
  MATCH_MVPS,
} from "./league-data.js?v=40";
import { initGabryssim } from "./gabryssim.js?v=40";
...
const TACTIC_BOARD_IMAGE = "assets/img/taktyka.jpg?v=40";
