...
import { PLAYERS, slugify } from "./players.js?v=37";
import { RECURRING_RULES, EXTRA_EVENTS, TYPE_META } from "./schedule.js?v=37";
import { isFirebaseConfigured, isPushConfigured, FIREBASE_VAPID_KEY } from "./firebase-config.js?v=37";
...
import {
  ...
  MATCH_MVPS,
} from "./league-data.js?v=37";
import { initGabryssim, refreshGabryssimButtonVisibility } from "./gabryssim.js?v=37";
...
const TACTIC_BOARD_IMAGE = "assets/img/taktyka.jpg?v=37";
